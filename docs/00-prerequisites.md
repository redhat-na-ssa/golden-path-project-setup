...
![](/images/system-design.gif) <br>

In order to use the Golden Path Template, you will need to create an OpenShift cluster and add the following components/operators:

1. Red Hat Trusted Application Pipeline
1. Service mesh 
